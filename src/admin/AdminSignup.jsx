...
function AdminSignup() {
 ...
 navigate("/admin/login");
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 h-[900px] ">
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
          ...
          <div className="flex items-center space-x-4 sm:mr-20 mr-3">
            <Link
              to={"/admin/login"}
        ...
        {/* Signup Form */}
        <div className="bg-gray-900 p-8  rounded-lg shadow-lg w-[500px] m-8 md:m-0 sm:mt-0 mt-50">
          <h2 className="text-2xl font-bold mb-4 text-center">
            Welcome to <span className="text-orange-500">CourseHaven</span>
          </h2>
          <p className="text-center text-gray-400 mb-6">
            Just Signup To access the admin dashboard!...
          </p>
