  ...
  const handleUpdateCourse = async (e) => {
    ...
    try {
      const response = await axios.put(
        ...
        `${import.meta.env.VITE_BASE_URL}/api/v1/course/update/${id}`,
        formData,
        {
          headers: {
      ...
      console.log("updatedcourse",response.data.course)
    } catch (error) {
      console.error(error);
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto p-6 border rounded-lg shadow-lg ml-3 sm:ml-110">
